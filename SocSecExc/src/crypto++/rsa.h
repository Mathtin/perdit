...
class CRYPTOPP_DLL RSAFunction : public TrapdoorFunction, public X509PublicKey {
  ...
  public:
    ...
    void BERDecodePublicKey(BufferedTransformation &bt, bool parametersPresent,
                            size_t size);
...
class CRYPTOPP_DLL InvertibleRSAFunction : public RSAFunction,
  ...
  public:
    ...
    void BERDecodePrivateKey(BufferedTransformation &bt, bool parametersPresent,
                             size_t size);
    void DEREncodePrivateKey(BufferedTransformation &bt) const;

    // TrapdoorFunctionInverse
    Integer CalculateInverse(RandomNumberGenerator &rng,
...
//! \sa <a href="http://www.weidai.com/scan-mirror/ca.html#RSA">RSA
//! cryptosystem</a>
...
//! \details See documentation of PKCS1v15 for a list of hash functions that can
//! be used with it.
//! \sa <a href="http://www.weidai.com/scan-mirror/sig.html#RSA">RSA signature
//! scheme with appendix</a>
...
//! \brief \ref RSASS<STANDARD,HASH> "RSASS<PKCS1v15, Weak::MD2>::Signer"
//! typedef
//! \details RSA signature schemes defined in PKCS #1 v2.0
class RSASSA_PKCS1v15_MD2_Signer : public RSASS<PKCS1v15, Weak1::MD2>::Signer {
};
//! \brief \ref RSASS<STANDARD,HASH> "RSASS<PKCS1v15, Weak::MD2>::Verifier"
//! typedef
//! \details RSA signature schemes defined in PKCS #1 v2.0
class RSASSA_PKCS1v15_MD2_Verifier
    : public RSASS<PKCS1v15, Weak1::MD2>::Verifier {};

//! \brief \ref RSASS<STANDARD,HASH> "RSASS<PKCS1v15, Weak::MD5>::Signer"
//! typedef
//! \details RSA signature schemes defined in PKCS #1 v2.0
class RSASSA_PKCS1v15_MD5_Signer : public RSASS<PKCS1v15, Weak1::MD5>::Signer {
};
//! \brief \ref RSASS<STANDARD,HASH> "RSASS<PKCS1v15, Weak::MD5>::Verifier"
//! typedef
//! \details RSA signature schemes defined in PKCS #1 v2.0
